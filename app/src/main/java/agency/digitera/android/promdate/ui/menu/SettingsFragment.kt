package agency.digitera.android.promdate.ui.menu
...
import agency.digitera.android.promdate.data.UpdateResponse
...
import agency.digitera.android.promdate.util.HintAdapter
import agency.digitera.android.promdate.util.LoadUrl
import agency.digitera.android.promdate.util.MissingSpException
import agency.digitera.android.promdate.util.dialog.AddPhotoDialogFragment
...
class SettingsFragment : Fragment() {
            ...
            override fun onResponse(call: Call<UserResponse>, response: Response<UserResponse>) {
                ...
                if (serverResponse != null && serverResponse.status == 200) {
                    ...
                    if (user.partner != null) {
                        ...
                        current_partner_text.text =
                            getString(R.string.currently_matched, user.partner?.firstName, user.partner?.lastName)
    ...
    private fun getImageFile(): File {
        ...
        val storageDir: File =
            context?.getExternalFilesDir(Environment.DIRECTORY_PICTURES) ?: throw Exception("Context not found")
