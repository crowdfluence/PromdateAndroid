                    ...
                    when (userPosition) {
                        0 -> {
                            if (user.self.profilePictureUrl.isNotEmpty()) {
                                context?.let { LoadUrl.loadProfilePicture(it, profile_picture_1_image, user.self.profilePictureUrl) }
                            }
                        ...
                        1 -> {
                            if (user.self.profilePictureUrl.isNotEmpty()) {
                                context?.let { LoadUrl.loadProfilePicture(it, profile_picture_2_image, user.self.profilePictureUrl) }
                            }
