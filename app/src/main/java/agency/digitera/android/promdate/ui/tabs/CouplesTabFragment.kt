package agency.digitera.android.promdate.ui.tabs
...
class CouplesTabFragment : Fragment(), TabInterface {
    ...
    private fun initializedPagedListBuilder(config: PagedList.Config):
        ...
        livePageListBuilder.setBoundaryCallback(
            CoupleBoundaryCallback(
                (activity as MainActivity).couplesDb,
                token
            )
        )
