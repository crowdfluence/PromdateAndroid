package agency.digitera.android.promdate.ui.dress
...
import agency.digitera.android.promdate.ui.dress.adapter.DressAdapter
...
class DressListFragment : Fragment() {
    ...
    private fun loadDresses() {
        val names = listOf(
            ...
            "Yet another dress",
            "Too many dresses!",
            "Something possibly nice",
            "Finally the last dress"
        )
        val modelNums =
            listOf("#001", "#002", "#003", "#004", "#005", "#006", "Bond, James Bond", "#008", "#009", "#010")
